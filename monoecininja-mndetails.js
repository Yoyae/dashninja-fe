...
var monoecininjaversion = '3.2.1';
var tablePayments = null;
var tableExStatus = null;
var dataProtocolDesc = [];
var maxProtocol = -1;
var monoecimainkeyregexp = /^[M][a-zA-Z0-9]{33}$/;
  ...
  $.getJSON( query, function( data ) {
   ...
   if ((!data.hasOwnProperty("data")) || (data.data.length < 1)) {
    ...
    if ((data.data[0].hasOwnProperty("Portcheck")) && (data.data[0].Portcheck != false)) {
		if ((data.data[0].Portcheck.SubVer.length > 11) && (data.data[0].Portcheck.SubVer.substring(0,14) == '/Monoeci Core:') && (data.data[0].Portcheck.SubVer.substring(data.data[0].Portcheck.SubVer.length-1) == '/')) {
			versioninfo = data.data[0].Portcheck.SubVer.substring(14,data.data[0].Portcheck.SubVer.indexOf('/',14));
		}
		if ((data.data[0].Portcheck.SubVer.length > 11) && (data.data[0].Portcheck.SubVer.substring(0, 17) == '/monacoCoin Core:') && (data.data[0].Portcheck.SubVer.substring(data.data[0].Portcheck.SubVer.length - 1) == '/')) {
			versioninfo = data.data[0].Portcheck.SubVer.substring(17, data.data[0].Portcheck.SubVer.indexOf('/', 17));
		}
		else if ((data.data[0].Portcheck.SubVer.length > 11) && (data.data[0].Portcheck.SubVer.substring(0, 14) == '/monoeci Core:') && (data.data[0].Portcheck.SubVer.substring(data.data[0].Portcheck.SubVer.length - 1) == '/')) {
			versioninfo = data.data[0].Portcheck.SubVer.substring(14, data.data[0].Portcheck.SubVer.indexOf('/', 14));
		}
    }
    else {
